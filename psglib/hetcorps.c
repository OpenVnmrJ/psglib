...
/* ACTUAL PULSE-SEQUENCE BEGINS  */
   ...
   status(B);
      ...
      {	
         if (d2 > 0.0)
          delay(d2/2.0 - (2*pp/3.1416) - 2.33*pw - rof1);
         else
          delay(d2/2.0);
      ...
      if (iphase == 0)
      ...
      else
        {
         ...
         delay(dly4/2.0 - 2.33*pp -(2*pp/3.1416) - rof2 - rof1);
