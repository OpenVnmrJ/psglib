#ifndef LINT
static char SCCSid[] = "@(#)hcchtocsy.c 1.2 10/11/94 Copyright (c) 1991-1994 Varian Assoc.,Inc. All Rights Reserved";
#endif
/* 
...
/* Create dipsi3 function */
  ...
  dipsi3a()
{
   decphase(one);   delay(2.722*p1);      /*245 deg pulse */
   decphase(three); delay(4.389*p1);      /*395 deg pulse */
   decphase(one);   delay(2.778*p1);      /*250 deg pulse */
   decphase(three); delay(3.056*p1);      /*275 deg pulse */
   decphase(one);   delay(0.333*p1);      /* 30 deg pulse */
   decphase(three); delay(2.556*p1);      /*230 deg pulse */
   decphase(one);   delay(4.000*p1);      /*360 deg pulse */
   decphase(three); delay(2.722*p1);      /*245 deg pulse */
   decphase(one);   delay(4.111*p1);      /*370 deg pulse */
   decphase(three); delay(3.778*p1);      /*340 deg pulse */
   decphase(one);   delay(3.889*p1);      /*350 deg pulse */
   decphase(three); delay(2.889*p1);      /*260 deg pulse */
   decphase(one);   delay(3.000*p1);      /*270 deg pulse */
   decphase(three); delay(0.333*p1);      /* 30 deg pulse */
   decphase(one);   delay(2.500*p1);      /*225 deg pulse */
   decphase(three); delay(4.056*p1);      /*365 deg pulse */
   decphase(one);   delay(2.833*p1);      /*255 deg pulse */
   decphase(three); delay(4.389*p1);      /*395 deg pulse */
}
...
{
   decphase(three); delay(2.722*p1);      /*245 deg pulse */
   decphase(one);   delay(4.389*p1);      /*395 deg pulse */
   decphase(three); delay(2.778*p1);      /*250 deg pulse */
   decphase(one);   delay(3.056*p1);      /*275 deg pulse */
   decphase(three); delay(0.333*p1);      /* 30 deg pulse */
   decphase(one);   delay(2.556*p1);      /*230 deg pulse */
   decphase(three); delay(4.000*p1);      /*360 deg pulse */
   decphase(one);   delay(2.722*p1);      /*245 deg pulse */
   decphase(three); delay(4.111*p1);      /*370 deg pulse */
   decphase(one);   delay(3.778*p1);      /*340 deg pulse */
   decphase(three); delay(3.889*p1);      /*350 deg pulse */
   decphase(one);   delay(2.889*p1);      /*260 deg pulse */
   decphase(three); delay(3.000*p1);      /*270 deg pulse */
   decphase(one);   delay(0.333*p1);      /* 30 deg pulse */
   decphase(three); delay(2.500*p1);      /*225 deg pulse */
   decphase(one);   delay(4.056*p1);      /*365 deg pulse */
   decphase(three); delay(2.833*p1);      /*255 deg pulse */
   decphase(one);   delay(4.389*p1);      /*395 deg pulse */
}
pulsesequence()
{
