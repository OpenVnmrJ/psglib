...
/* ensure that magnetization originates on H and not 13C  */
	...
	delay(14.0e-3 - 18.4e-6 - 1.5*pwN - tau2);
    ...
    else  if ( tau2 > (5.4e-3 - pwC4 - 5.75e-6) )
                {
                delay(14.0e-3 - pwN - 4.6e-6 - 5.4e-3 + tau2);
                xmtroff();
                obsprgoff();
                                                                /*  5.75us   */
                decshaped_pulse("offC4", pwC4, zero, 0.0, 0.0);
    ...
    else  if ( tau2 > gt1 + 1.138e-4)
		{
                delay(14.0e-3 - pwN - 4.6e-6 - 5.4e-3 + tau2);
                xmtroff();
                obsprgoff();
                delay(5.4e-3 - tau2 - pwC4 - 5.75e-6);
                                                                /*  5.75us   */
                decshaped_pulse("offC4", pwC4, zero, 0.0, 0.0);
                delay(tau2 - gt1 - 1.138e-4);
		rgradient('z', icosel*gzlvl1);			/*  6.9us    */
		delay(gt1);
		rgradient('z', 0.0);				/*  6.9us    */
		delay(1.0e-4);
                ...
                xmtroff();
	        obsprgoff();
                delay(5.4e-3 - tau2 - pwC4 - 5.75e-6 - gt1 - 1.138e-4);
		rgradient('z', icosel*gzlvl1);			/*  6.9us    */
		delay(gt1);
		rgradient('z', 0.0);				/*  6.9us    */
		delay(1.0e-4);
